...
{
    class PersonneNonAjouteeEventHandler : IDomainEventHandler<PersonneNonAjouteeEvent>
    {
        public Task HandleAsync(PersonneNonAjouteeEvent domainEvent, IEventContext context = null)
        {
